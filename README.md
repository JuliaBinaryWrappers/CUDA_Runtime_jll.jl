...
The originating [`build_tarballs.jl`](https://github.com/JuliaPackaging/Yggdrasil/blob/0f839ac9232e5ab371949139d8041678aa453c2f/C/CUDA/CUDA_Runtime/build_tarballs.jl) script can be found on [`Yggdrasil`](https://github.com/JuliaPackaging/Yggdrasil/), the community build tree.
...
* `Platform("x86_64", "windows"; cuda = "10.2")` (`x86_64-w64-mingw32-cuda+10.2`)
