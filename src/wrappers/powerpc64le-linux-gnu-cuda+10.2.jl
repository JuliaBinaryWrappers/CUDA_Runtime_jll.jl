# Autogenerated wrapper script for CUDA_Runtime_jll for powerpc64le-linux-gnu-cuda+10.2
export libcublas, libcudadevrt, libcudart, libcufft, libcupti, libcurand, libcusolver, libcusparse, libdevice, libnvvm, nvdisasm, nvlink, ptxas
