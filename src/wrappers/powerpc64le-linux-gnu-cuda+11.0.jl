# Autogenerated wrapper script for CUDA_Runtime_jll for powerpc64le-linux-gnu-cuda+11.0
export compute_sanitizer, libcublas, libcublasLt, libcudadevrt, libcudart, libcufft, libcupti, libcurand, libcusolver, libcusolverMg, libcusparse, libdevice, libnvperf_host, libnvperf_target, libnvrtc, libnvrtc_builtins, libnvvm, nvdisasm, nvlink, ptxas
...
JLLWrappers.@declare_library_product(libnvrtc_builtins, "libnvrtc-builtins.so.11.0")
...
JLLWrappers.@declare_library_product(libnvrtc, "libnvrtc.so.11.0")
