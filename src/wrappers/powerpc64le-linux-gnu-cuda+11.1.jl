# Autogenerated wrapper script for CUDA_Runtime_jll for powerpc64le-linux-gnu-cuda+11.1
...
JLLWrappers.@declare_library_product(libnvrtc, "libnvrtc.so.11.1")
JLLWrappers.@declare_library_product(libnvrtc_builtins, "libnvrtc-builtins.so.11.1")
