# Autogenerated wrapper script for CUDA_Runtime_jll for powerpc64le-linux-gnu-cuda+11.2
...
JLLWrappers.@declare_library_product(libnvrtc_builtins, "libnvrtc-builtins.so.11.2")
