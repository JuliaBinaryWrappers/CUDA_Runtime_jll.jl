...
export compute_sanitizer, libcublas, libcudadevrt, libcudart, libcufft, libcupti, libcurand, libcusolver, libcusolverMg, libcusparse, libdevice, libnvvm, nvdisasm, nvlink, ptxas
