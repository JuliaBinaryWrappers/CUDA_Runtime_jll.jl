...
export compute_sanitizer, libcublas, libcublasLt, libcudadevrt, libcudart, libcufft, libcupti, libcurand, libcusolver, libcusolverMg, libcusparse, libdevice, libnvJitLink, libnvPTXCompiler, libnvvm, nvdisasm, nvlink, ptxas
