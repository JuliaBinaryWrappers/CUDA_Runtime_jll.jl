# Autogenerated wrapper script for CUDA_Runtime_jll for x86_64-linux-gnu-cuda+11.3
...
JLLWrappers.@declare_library_product(libnvrtc_builtins, "libnvrtc-builtins.so.11.3")
